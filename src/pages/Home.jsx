...
const Home = () => {
  ...
  <nav className="grid grid-flow-col gap-4">
    <Link to="https://support.notreal003.xyz/contact" className="link link-hover">Contact Us</Link>
  ...
  <aside>
    <p>Copyright © ${new Date().getFullYear()} NotReal003 - All rights reserved.</p>
  </aside>
</footer>
    </div>
  );
