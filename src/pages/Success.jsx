  ...
  const Success = () => {
    ...
    return (
      <div className="flex items-center justify-center bg-base-50 h-screen">
        <div className="text-center">
          ...
          <p className="text-lg">
            Thanks for submitting a request, {user.name}. We will notify you at {user.email}. Join our Discord Server so we may contact you :)
          </p>
          <Link to="/one" className="btn btn-outline btn-info mt-4 w-full">
            <CircleCheck className='size-4'/> Your Requests
          </Link>
          <a target="_blank" rel="noopener noreferrer" href="https://discord.gg/sqVBrMVQmp" className="btn btn-outline btn-primary w-full mt-5">
