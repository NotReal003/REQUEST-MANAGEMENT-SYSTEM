...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500">
      <div className="bg-gradient-to-br from-indigo-400 via-purple-400 to-pink-400 p-8 opacity-75 rounded-lg shadow-lg max-w-sm w-full">
        ...
        <Link 
          ...
          className="btn btn-outline btn-primary w-full mt-5 flex items-center justify-center transition-all duration-200 hover:shadow-lg hover:bg-primary hover:text-white"
        >
